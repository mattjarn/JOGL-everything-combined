...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		//imported object
		myObj = new ImportedModel("pyr.obj");
		joglObjectTexture = loadTexture("src/project3/Resources/earth.jpg");
		objectTexture = joglObjectTexture.getTextureObject();
		objectLoc.setX(5.0); objectLoc.setY(5.0f); objectLoc.setZ(0.0f);
		setupVertices();

		Texture t = loadTexture("src/project3/Resources/brick1.jpg");
		textureID1 = t.getTextureObject();

		t = loadTexture("src/project3/Resources/alien.jpg");
...
//-----------------
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		vBlinn1ShaderSource = util.readShaderSource("src/project3/Shaders/blinnVert1.shader");
		vBlinn2ShaderSource = util.readShaderSource("src/project3/Shaders/blinnVert2.shader");
		fBlinn2ShaderSource = util.readShaderSource("src/project3/Shaders/blinnFrag2.shader");
		CvertShaderSource = util.readShaderSource("src/project3/Shaders/vert.shader");
		CfragShaderSource = util.readShaderSource("src/project3/Shaders/frag.shader");
		importvshaderSource = util.readShaderSource("src/project3/Shaders/vert2.shader");
		importfshaderSource = util.readShaderSource("src/project3/Shaders/frag2.shader");
